document.addEventListener("DOMContentLoaded", function () {
    ...
    // Section buttons
    const filterButtons = document.querySelectorAll(".cert-sect ul button");
    ...
    function renderCourses(filter = "all") {
        ...
        courseCount.textContent = `The total number of course listed below is ${filteredCourses.length} with ${totalCredits} credits remaining.`;
